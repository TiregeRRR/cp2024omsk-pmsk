...
class AlignmentParams(BaseModel):
    align_model: str | None = Field(Query(None, description="Name of phoneme-level ASR model to do alignment"))
...
class DiarizationParams(BaseModel):
    min_speakers: int | None = Field(Query(None, description="Minimum number of speakers to in audio file"))
    max_speakers: int | None = Field(Query(None, description="Maximum number of speakers to in audio file"))
