...
from app.services import process_alignment, process_diarize, process_speaker_assignment, process_transcribe
from app.tasks import add_task_to_db
from app.transcript import filter_aligned_transcription
from app.whisperx_services import device
...
def align(
    ...
    background_tasks.add_task(process_alignment, audio, transcript.model_dump(), identifier, device, align_params, session)
